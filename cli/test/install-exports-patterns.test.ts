...
test("Install with exports field subpath patterns", async () => {
  await run({
    ...
    validationFn: async (files: Map<string, string>) => {
      ...
      assert.strictEqual(
        map.imports!["test-package/styles/main.css"],
        "./assets/css/main.css"
      );
      assert.strictEqual(
        map.imports!["test-package/styles/theme.css"],
      ...
      assert.strictEqual(
        map.imports!["test-package/lib/math"],
        "./lib/esm/math.js"
      );
      assert.strictEqual(
        map.imports!["test-package/lib/string"],
        "./lib/esm/string.js"
      );
    },
  });
