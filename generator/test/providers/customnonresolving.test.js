...
const generator = new Generator({
  customProviders: {
    custom: {
      ownsUrl(url) {
        return (
          url.startsWith('https://framerusercontent.com/') ||
          url.startsWith('https://framerusercontent.dev/')
        );
      },
...
await generator.link(
  'https://framerusercontent.com/modules/hbDCoHjvQqMyIH6I6akS/JpP37lZcTYRA5qoY1Tdv/Qhb7p35zo.js'
);
